...
from gestureapp.guis.login.loginui import Ui_Login
from gestureapp.devs.login.facedev import FaceThread
...
"""
class GestureLogin(QDialog):
    signal_home = pyqtSignal()
    def __init__(self):
        super(GestureLogin, self).__init__()
